...
namespace Gazel {
  ...
  void EditorLayer::OnAttach()
  {
    ...
    Gazel::FramebufferSpecification fbSpec;
    fbSpec.Width = 1280;
    fbSpec.Height = 720;
    m_Framebuffer = Gazel::Framebuffer::Create(fbSpec);
  }
  ...
  void EditorLayer::OnUpdate(Gazel::Timestep ts)
  {
    GZ_PROFILE_FUNCTION();
  ...
  void EditorLayer::OnImGuiRender()
  {
    ...
    if (ImGui::BeginMenuBar())
    {
      if (ImGui::BeginMenu("File"))
      {
        ...
        if (ImGui::MenuItem("Exit")) Gazel::Application::Get().Close();
        ImGui::EndMenu();
      }
  ...
  void EditorLayer::OnEvent(Gazel::Event& e)
  {
